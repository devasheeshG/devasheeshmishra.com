export const HuggingFaceIcon = (props: React.SVGProps<SVGSVGElement>) => {
  // TODO: This icon is not consistent with others, fix it later.
  return (
    <svg
    ...
    >
      ...
      >
        ...
        <stop offset="1" stopColor="#ff8100" />
      </linearGradient>
      <path
      ...
      >
        ...
        <stop offset=".364" stopColor="#feca17" />
        <stop offset=".941" stopColor="#fbb302" />
        <stop offset="1" stopColor="#fbb000" />
      </linearGradient>
      <path
      ...
      >
        ...
        <stop offset="1" stopColor="#c8202c" />
      </linearGradient>
      <path
